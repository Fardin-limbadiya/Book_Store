      ...
      <section className="container">
        <div className=" grid md:grid-cols-3 py-5">
          ...
          <div className=" py-8 px-4 ">
            ...
            <p className="">
            Providing a diverse collection of books, seamless browsing, and personalized recommendations for every reader.{" "}
            </p>
            <br />
        ...
        <div>
          <div className="text-center py-10 border-t-2 border-gray-300/50">
            @copyright 2024 All rights reserved by 'Fardin Limbadiya'
          </div>
        </div>
      </section>
    </div>
